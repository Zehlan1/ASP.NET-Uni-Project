...
namespace ASP.NET_Uni_Project.Controllers
{
    public class ProducerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Founded")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Founded")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
